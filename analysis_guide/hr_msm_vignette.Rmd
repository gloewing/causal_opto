...
Alex Levis$\ast$, Gabriel Loewinger$\ast$, Francisco Pereira. [Causal inference in the closed-loop: marginal structural models for sequential excursion effects](https://arxiv.org/abs/2405.18597v1). NeurIPS (2024).
